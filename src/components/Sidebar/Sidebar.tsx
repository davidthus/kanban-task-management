...
const Sidebar = () => {
  ...
  return data.sideBarsOpen === "true" ? (
    <SidebarContainer open={data.sideBarsOpen === "true" ? true : false}>
      <BoardTabsContainer>
        ...
        <BoardTabsWrapper>
          ...
          <NewBoardButton
            onClick={() =>
              dispatch(openModal({ modalType: "add-board", modalDetail: {} }))
            }
          >
            <svg width="16" height="16" xmlns="http://www.w3.org/2000/svg">
              <path
      ...
      <TogglesWrapper>
        <ThemeToggler />
        <HideSidebarToggle onClick={() => dispatch(toggleSidebar())}>
    ...
    <ShowSidebarToggle onClick={() => dispatch(toggleSidebar())}>
      <ShowIcon />
    </ShowSidebarToggle>
  );
};
